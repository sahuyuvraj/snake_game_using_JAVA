...
public class Gamepanel extends JPanel implements ActionListener {
	static final int SW=800;      //screen width
	static final int SH=600;//screen height
	static final int UNIT_SIZE=25;
	static final int GAME_UNITS=(SW*SH)/UNIT_SIZE;
	...
	public void gameOver(Graphics g) {
		...
		g.drawString("Game Over!!", (SW-metrics1.stringWidth("Game Over!!"))/2,SH/2);
		g.setColor(Color.red);
		g.setFont(new Font("Ink Free",Font.BOLD,40));
		FontMetrics metrics2=getFontMetrics(g.getFont());
		g.drawString("Score: "+applesEaten, (SW-metrics2.stringWidth("Score: "+applesEaten))/2,g.getFont().getSize()*9);
